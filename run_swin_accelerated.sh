...
$path_swin'main_accelerated.py' --distributed --use_checkpoint --lrschedule='cosine_anneal' --json_list=$path_swin'jsons/brats23_africa_folds.json' --sw_batch_size=4 --batch_size=2 --data_dir=$path_data --val_every=10 --infer_overlap=0.7 --in_channels=4 --spatial_dims=3 --feature_size=48 --max_epochs=80 --logdir='8_gpu_80_epochs'
